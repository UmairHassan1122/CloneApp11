...
import { View, Text, Image, StyleSheet, KeyboardAvoidingView, TouchableOpacity, ActivityIndicator, SafeAreaView } from 'react-native'
...
export default function SignupScreen({ navigation }) {
    ...
    const pickImageAndUpload = () => {
        launchImageLibrary({ quality: 0.5 }, (fileobj) => {
            const data = fileobj.assets;
            const uploadTask = storage().ref().child(`/userprofile/${Date.now()}`).putFile(data[0].uri)
